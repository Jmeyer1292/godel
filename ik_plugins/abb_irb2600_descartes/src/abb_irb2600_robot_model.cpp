...
#include <abb_irb2600_descartes/abb_irb2600_robot_model.h>
...
using namespace irb2600_ikfast_manipulator_plugin;

namespace abb_irb2600_descartes
{
  AbbIrb2600RobotModel::AbbIrb2600RobotModel():
  ...
  bool AbbIrb2600RobotModel::initialize(const std::string& robot_description, const std::string& group_name,
                                    const std::string& world_frame,const std::string& tcp_frame)
  {
    MoveitStateAdapter::initialize(robot_description,group_name,world_frame,tcp_frame);
    irb2600_ikfast_manipulator_plugin::IKFastKinematicsPlugin::initialize(robot_description, group_name, MOTOMAN_SIA20D_BASE_LINK,
  ...
  bool AbbIrb2600RobotModel::getAllIK(const Eigen::Affine3d &pose,
...
PLUGINLIB_EXPORT_CLASS(abb_irb2600_descartes::AbbIrb2600RobotModel,descartes_core::RobotModel)
