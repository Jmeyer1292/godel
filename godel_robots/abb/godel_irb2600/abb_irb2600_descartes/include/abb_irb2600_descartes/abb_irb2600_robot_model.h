...
#ifndef ABB_IRB2600_ROBOT_MODEL_H
#define ABB_IRB2600_ROBOT_MODEL_H
...
{
  class AbbIrb2600RobotModel: public descartes_moveit::MoveitStateAdapter,
    public irb2600_ikfast_manipulator_plugin::IKFastKinematicsPlugin
{
  public:

    AbbIrb2600RobotModel();
