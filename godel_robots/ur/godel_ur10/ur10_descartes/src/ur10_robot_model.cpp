...
#include <ur10_descartes/ur10_robot_model.h>
                          ...
                          const std::string& world_frame,const std::string& tcp_frame)
{
  ...
  if(!ur_kinematics::URKinematicsPlugin::initialize(robot_description, group_name, UR10_BASE_LINK,UR10_TIP_LINK, 0.001))
  {
